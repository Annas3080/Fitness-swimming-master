            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $phplogin['role']; ?></td>
                        <td>
                            <a href="edit.php?id=<?php echo $phplogin['id']; ?>" class="btn btn-warning">แก้ไข</a>
                            <a onclick="return confirm('Are you sure you want to delete?');" href="?delete=<?php echo $phplogin['id']; ?>" class="btn btn-danger">ลบข้อมูล</a>
                        </td>
                    </tr>
                <?php }  } ?>
            </tbody>
